        ...
        <div class="container">
            ...
            <div class="drag-box">
                <div class="drag-box-item">
                    ...
                    <draggable v-model.trim="todo" @remove="removeHandle" :options="dragOptions">
                ...
                <div class="drag-box-item">
                    ...
                    <draggable v-model.trim="doing" @remove="removeHandle" :options="dragOptions">
                ...
                <div class="drag-box-item">
                    ...
                    <draggable v-model.trim="done" @remove="removeHandle" :options="dragOptions">
