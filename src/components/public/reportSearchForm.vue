    ...
    <div class="body">
        ...
        <el-form :inline="true" size='small' ref="searchForm" :model="searchForm" label-position="left"
            ...
            <el-row v-show='isShow'>
                <el-col :span="8">
                    <el-form-item label="合同号" prop='contractSerialNo'>
                        <el-input v-model.trim="searchForm.contractSerialNo" placeholder='请输入合同号' suffix-icon="empty"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="客户名称" prop='customerName'>
                        <el-input v-model.trim="searchForm.customerName" placeholder='请输入客户名称' suffix-icon="empty"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="证件号码" prop='certId'>
                        <el-input v-model.trim="searchForm.certId" placeholder='请输入证件号码' suffix-icon="empty"></el-input>
                    </el-form-item>
                </el-col>
                <!-- <el-col :span="8">
                ...
                <el-col :span="12">
                    <el-form-item label="应还日期" prop='time'>
                        <el-date-picker style="width: 96%" v-model.trim="searchForm.time" type="daterange"
            ...
            <el-row v-show='isShow'> -->
                <el-col :span="12">
                    <el-form-item label="送盘日期" prop='putoutDate'>
                        <el-date-picker style="width: 96%" v-model.trim="searchForm.putoutDate" type="daterange"
                            :picker-options="pickerOptions" value-format='yyyy/MM/dd' range-separator="至"
                            start-placeholder="开始" end-placeholder="结束" align="right">
                        </el-date-picker>
                    </el-form-item>
                ...
                <el-col :span="12">
                    <el-form-item label="回盘日期" prop='inputDate'>
                        <el-date-picker style="width: 96%" v-model.trim="searchForm.inputDate" type="daterange"
                            :picker-options="pickerOptions" value-format='yyyy/MM/dd' range-separator="至"
                            start-placeholder="开始" end-placeholder="结束" align="right">
                        </el-date-picker>
                    </el-form-item>
    ...
    export default {
        ...
        data() {
            return {
                searchForm: {
                    ...
                    putoutDate: [],
                    inputDate: [],
                    payDateEnd: null, // 应还日期-结束 ,
                    payDateBegin: null, // 应还日期-开始 ,
                    withholdDateBegin: null, // 送盘日期-开始 ,
                    withholdDateEnd: null, // 送盘日期-结束 ,
                    inputDateBegin: null, // 回盘时间-开始 ,
                    inputDateEnd: null, // 回盘时间-结束 ,
        ...
        methods: {
            ...
            queryHandle() {
                ...
                this.searchForm.payDateBegin = this.searchForm.time && this.searchForm.time[0]; // 应还日期-开始 , 
                this.searchForm.payDateEnd = this.searchForm.time && this.searchForm.time[1]; // 应还日期-结束 ,
                // 送盘日期
                this.searchForm.withholdDateBegin = this.searchForm.putoutDate && this.searchForm.putoutDate[
                    0]; // 送盘日期-开始 , 
                this.searchForm.withholdDateEnd = this.searchForm.putoutDate && this.searchForm.putoutDate[
                    1]; // 送盘日期-结束 ,
                // 回盘时间
                this.searchForm.inputDateBegin = this.searchForm.inputDate && this.searchForm.inputDate[
                    0]; // 回盘时间-开始 , 
                this.searchForm.inputDateEnd = this.searchForm.inputDate && this.searchForm.inputDate[
                    1]; // 回盘时间-结束 ,
