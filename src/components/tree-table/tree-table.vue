						...
						<tr>
							<td>
								<tree-item v-for="(model,i) in treeDataSource" :key="'root_node_'+i" :root="0" :num="i"
									@click="aaa(model)" @actionFunc="actionFunc" @deleteFunc="deleteFunc"
									@handlerExpand="handlerExpand" @rowClick="rowClick" :nodes="treeDataSource.length"
