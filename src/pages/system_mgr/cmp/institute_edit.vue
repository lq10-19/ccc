<template>
  <div>
    <el-dialog title="编辑" :visible.sync="isEdit" :before-close="modalClose" width="680px">
      <div class="modal-inner">
        <el-form style="padding: 0 20px" ref="form" :model="formData" label-width="100px" label-position='left'>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      modalClose() {
        bus.$emit("institute:isEdit", false); // 直接修改父组件的属性
      },
