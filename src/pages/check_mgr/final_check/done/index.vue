<template>
  <div class="container">
    ...
    <el-table :data="tableData" border :height='tableHeight' class="table" ref="multipleTable" highlight-current-row
      ...
      <el-table-column prop="serialNo" min-width="110" label="合同号" align="center"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      async getDataList() {
        ...
        try {
          let res = await queryCheckLastFinished({
            ...this.queryParams
          })
