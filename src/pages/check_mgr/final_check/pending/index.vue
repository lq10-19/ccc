  ...
  <div class="container">
    ...
    <div class="pagination">
      <el-pagination background @current-change="handleCurrentChange" @size-change="handleSizeChange"
        :current-page.sync="currentPageS" :page-sizes="[10, 20, 30, 40]" :page-size="10"
        layout="total,sizes, prev, pager, next" :total="totalPage">
      </el-pagination>
    </div>

    <!-- 签署意见 -->
    <SigningModel m_title='签署意见' :isShowModal='isShowModal' source='审批终审' :columnInfo='selection'></SigningModel>
    <!-- 提交审核 -->
    <ExamineModel m_title='提交审核' :isShowModal='isShowModal_E' :serialNoList='serialNoList' source='审批终审'
      :columnInfo='selection'></ExamineModel>
    <!-- 查看意见 -->
    <SeeViewModel m_title='查看意见' :isShowModal='isShowModal_S' source='审批终审' :columnInfo='selection'></SeeViewModel>
    <!-- 个人状态 -->
    <PstatusModel m_title='个人状态' :isShowModal='isShowModal_P' source='审批终审' :columnInfo='selection'></PstatusModel>
    <!-- 查看调单记录 -->
    <PecordModel m_title='查看调单记录' :isShowModal='isShowModal_C' source='审批终审' :columnInfo='selection'></PecordModel>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async getDataList() {
        console.log(this.queryParams, 444)
        let res = await queryCheckLast({
          ...this.queryParams
        })
