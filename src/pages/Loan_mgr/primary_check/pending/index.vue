<template>
  <div class="container">
    ...
    <!-- 签署意见 -->
    <SigningModel m_title='签署意见' :isShowModal='isShowModal' source='放款初审' :columnInfo='selection'></SigningModel>
    <!-- 提交审核 -->
    <ExamineModel m_title='提交审核' :isShowModal='isShowModal_E' source='放款初审' :serialNoList='serialNoList'
    ...
    <!-- 个人状态 -->
    <PstatusModel m_title='个人状态' :isShowModal='isShowModal_P' source='放款初审' :columnInfo='selection'></PstatusModel>
    <!-- 查看调单记录 -->
    ...
    methods: {
      ...
      async getDataList() {
        try {
          ...
          let res = await queryLoanCheckFirst({
            ...this.queryParams
          })
          console.log(res, 11)
